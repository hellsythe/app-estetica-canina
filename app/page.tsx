...
export default function Dashboard() {
  ...
  const getRoleWelcomeMessage = (role: string) => {
    switch (role) {
      ...
      case 'manager':
        return 'Gestiona las operaciones del negocio';
      case 'employee':
        return 'Gestiona citas y atiende clientes';
      default:
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">{getRoleWelcomeMessage(user?.role || '')}</p>
            </div>
                  ...
                  {recentAppointments.map((appointment) => (
                    <div key={appointment.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      ...
                      <div className="text-right">
                        ...
                        <Badge variant={
                          appointment.status === 'En Proceso' ? 'default' :
